const CACHE_CONFIG = {
  ...
  folders: {
    ...
    '/components/': ['button-grid.css', 'button-grid.js', 'group-rgb-picker.css', 'group-rgb-picker.js', 'imu-data-display.css', 'imu-data-display.js', 'input-config-panel.css', 'input-config-panel.js', 'input-mapping-display.css', 'input-mapping-display.js', 'joystick-visual.css', 'joystick-visual.js', 'mac-address-selector.css', 'mac-address-selector.js', 'multi-position-button.css', 'multi-position-button.js', 'number-selector.css', 'number-selector.js', 'remap-box.css', 'remap-box.js', 'sensor-visualization.css', 'sensor-visualization.js', 'single-shot-button.css', 'single-shot-button.js', 'text-entry.css', 'text-entry.js', 'tristate-button.css', 'tristate-button.js', 'waveform-display.css', 'waveform-display.js'],
