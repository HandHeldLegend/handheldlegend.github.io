const CACHE_CONFIG = {
  version: 'v0.003.038', // Increment this when you update files
  folders: {
    '/': ['attributions.txt', 'index.html', 'manifest.json', 'ping.json'],
    '/assets/3d/': ['supergamepad.stl', 'supergamepadOLD.stl'],
    '/assets/icons/': ['analog.svg', 'battery.svg', 'dpad.svg', 'gamepad.svg', 'haptics.svg', 'motion.svg', 'remap.svg', 'rgb.svg', 'snapback.svg', 'triggers.svg', 'user.svg', 'wireless.svg'],
    '/components/': ['angle-modifier.css', 'angle-modifier.js', 'button-grid.css', 'button-grid.js', 'group-rgb-picker.css', 'group-rgb-picker.js', 'imu-data-display.css', 'imu-data-display.js', 'input-config-panel.css', 'input-config-panel.js', 'input-mapping-display.css', 'input-mapping-display.js', 'joystick-visual.css', 'joystick-visual.js', 'mac-address-selector.css', 'mac-address-selector.js', 'multi-position-button.css', 'multi-position-button.js', 'number-selector.css', 'number-selector.js', 'remap-box.css', 'remap-box.js', 'sensor-visualization.css', 'sensor-visualization.js', 'single-shot-button.css', 'single-shot-button.js', 'text-entry.css', 'text-entry.js', 'tristate-button.css', 'tristate-button.js', 'waveform-display.css', 'waveform-display.js'],
    ...
    '/images/glyphs/': ['1.png', '2.png', '3.png', '4.png', '5.png', '6.png', 'a.png', 'b.png', 'back.png', 'capture.png', 'cdown.png', 'cleft.png', 'cright.png', 'cup.png', 'cx+.png', 'cx-.png', 'cy+.png', 'cy-.png', 'ddown.png', 'disabled.png', 'dleft.png', 'dright.png', 'dup.png', 'east.png', 'gl.png', 'gr.png', 'guide.png', 'home.png', 'l.png', 'l1.png', 'l2.png', 'l2a.png', 'l3.png', 'l4.png', 'l5.png', 'lb.png', 'lg.png', 'lp.png', 'ls.png', 'lt.png', 'lx+.png', 'lx-.png', 'ly+.png', 'ly-.png', 'l↗.png', 'l↘.png', 'minus.png', 'nb1.png', 'nb2.png', 'north.png', 'plus.png', 'power.png', 'r.png', 'r1.png', 'r2.png', 'r2a.png', 'r3.png', 'r4.png', 'r5.png', 'rb.png', 'rg.png', 'rp.png', 'rs.png', 'rt.png', 'rx+.png', 'rx-.png', 'rx.png', 'ry+.png', 'ry-.png', 'ry.png', 'r↗.png', 'r↘.png', 'select.png', 'sguide.png', 'share.png', 'sl.png', 'soptions.png', 'south.png', 'sr.png', 'sselect.png', 'start.png', 'sview.png', 'tp.png', 'tpl.png', 'tpr.png', 'west.png', 'x+.png', 'x-.png', 'x.png', 'y+.png', 'y-.png', 'y.png', 'z.png', 'zl.png', 'zr.png'],
    '/js/': ['app.js', 'gamepad.js', 'legacy.js', 'module-registry.js', 'pico_update.js', 'tooltips.js'],
    '/libs/': ['STLLoader.js', 'three.min.js'],
    '/modules/': ['analog-md.js', 'battery-md.js', 'debug-md.js', 'dpad-md.js', 'gamepad-md.js', 'haptic-md.js', 'input-md.js', 'motion-md.js', 'oldwireless-md.js', 'rgb-md.js', 'snapback-md.js', 'user-md.js', 'wireless-md.js']
  }
};
