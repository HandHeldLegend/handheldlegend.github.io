const CACHE_CONFIG = {
  ...
  folders: {
    ...
    '/components/': ['analog-stick-visual.js', 'angle-selector.css', 'angle-selector.js', 'axis-invert-selector.css', 'axis-invert-selector.js', 'button-grid.css', 'button-grid.js', 'group-rgb-picker.css', 'group-rgb-picker.js', 'host-template.css', 'imu-data-display.css', 'imu-data-display.js', 'input-config-panel.css', 'input-config-panel.js', 'input-mapping-display.css', 'input-mapping-display.js', 'joystick-visual.css', 'joystick-visual.js', 'mac-address-selector.css', 'mac-address-selector.js', 'multi-position-button.css', 'multi-position-button.js', 'number-selector.css', 'number-selector.js', 'sensor-visualization.css', 'sensor-visualization.js', 'single-shot-button.css', 'single-shot-button.js', 'text-entry.css', 'text-entry.js', 'tristate-button.css', 'tristate-button.js', 'waveform-display.css', 'waveform-display.js'],
    ...
    '/modules/': ['analog-md.js', 'debug-md.js', 'battery-md.js', 'dpad-md.js', 'gamepad-md.js', 'haptic-md.js', 'input-md.js', 'motion-md.js', 'rgb-md.js', 'snapback-md.js', 'user-md.js', 'wireless-md.js']
  }
};
