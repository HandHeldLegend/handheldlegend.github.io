const CACHE_CONFIG = {
  version: 'v0.003.019', // Increment this when you update files
  folders: {
    ...
    '/modules/': ['analog-md.js', 'battery-md.js', 'dpad-md.js', 'gamepad-md.js', 'haptic-md.js', 'input-md.js', 'motion-md.js', 'rgb-md.js', 'snapback-md.js', 'user-md.js', 'wireless-md.js']
  }
};
